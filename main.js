...
module.exports.loop = function () {
    ...
    for (let spawnName in Game.spawns) {
        ...
        if (numberOfHarvesters == 0 && (numberOfMiners == 0 || numberOfCarriers == 0)) {
            if (numberOfMiners > 0 || (spawn.room.storage != undefined && spawn.room.storage.store[RESOURCE_ENERGY] >= (((SOURCE_ENERGY_CAPACITY / ENERGY_REGEN_TIME / 2) * BODYPART_COST[WORK] + BODYPART_COST[MOVE]) + 150))) {
        ...
        if (!(name < 0)) {
            ...
            console.log("Carriers      : " + numberOfCarriers + "/" + spawn.memory.minCarriers);
